...
*   [Is there’s a code for &lsqb;insert thing you want to do here&rsqb;?](../general-faq.md#is-theres-a-code-for-insert-thing-you-want-to-do-here)
*   [The code isn’t working](../general-faq.md#the-code-isnt-working)
    +   [You typed the box names wrong](../general-faq.md#you-typed-the-box-names-wrong)
    +   [You have Pokémon data present in box slots that are meant to be empty](../general-faq.md#you-have-pokémon-data-present-in-box-slots-that-are-meant-to-be-empty)
    +   [You made a mistake in the ACE setup itself](../general-faq.md#you-made-a-mistake-in-the-ace-setup-itself)
*   [How can I delete bad eggs and/or unwanted glitch Pokémon?](../general-faq.md#how-can-i-delete-bad-eggs-andor-unwanted-glitch-pokémon)
    +   [Using reverse Battle Tower cloning to delete Pokémon and bad eggs](../general-faq.md#using-reverse-battle-tower-cloning-to-delete-pokémon-and-bad-eggs)
...
*   [I am playing on the Switch rerelease and the codes do not work!](../frlg-faq.md#i-am-playing-on-the-switch-rerelease-and-the-codes-do-not-work)
    ...
    +   [The code still does not work](../frlg-faq.md#the-code-still-does-not-work)

## Pokémon Emerald

*   [I do not have a clean DOTS to EV train](../emerald-faq.md#i-do-not-have-a-clean-dots-to-ev-train)
*   [I do not have a clean PLUSES](../emerald-faq.md#i-do-not-have-a-clean-pluses)
*   [My trainer card stats look corrupted](../emerald-faq.md#my-trainer-card-stats-look-corrupted)
